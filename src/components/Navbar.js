...
export default ()=>{ 
    ...
    <Menu pageWrapId="page-wrap" outerContainerId="outer-container" disableCloseOnEsc>
        ...
        <Fade collapse when={slope}>
            ...
            <a className="bm-item dropdown-item calc"href="/slope">kalkulator</a>
        </Fade>
        <button onClick={()=>setFriction(!friction)}>Tarcie</button>
        <Fade collapse when={friction}><a className="bm-item dropdown-item"href="/friction">symulator</a><a className="bm-item dropdown-item"href="/slope">kalkulator</a></Fade>
        <button onClick={()=>setSlope(!slope)}>Równia pochyła</button>
    </Menu>);
